...
my_entry = Entry(root, font=("Heltevica 12 bold"), bg="wheat", fg="black")
my_entry.pack(pady=20)

create_button = Button(root, font=("Heltevica 10 bold"), text="Create Qr Code",bg="wheat", fg="black", command=create_qr_code)
create_button.pack(pady=20)

clear_button = Button(root, font=("Heltevica 10 bold"), text="Clear", bg="wheat", fg="black", command=clear_all)
clear_button.pack()
